...
class TestTokenUsage:
    ...
    def test_token_usage_creation(self):
        ...
        from translatorhoi4.translator.cost_tracker import TokenUsage
...
class TestCostTracker:
    ...
    def tracker(self, tmp_path):
        ...
        from translatorhoi4.translator.cost_tracker import CostTracker
...
class TestTokenEstimator:
    ...
    def test_estimate_tokens_english(self):
        ...
        from translatorhoi4.translator.cost_tracker import TokenEstimator
    ...
    def test_estimate_completion_tokens(self):
        ...
        tokens = TokenEstimator.estimate_completion_tokens(source, "english")
        assert tokens > 0
    ...
    def test_estimate_completion_tokens_expansion(self):
        ...
        completion_tokens = TokenEstimator.estimate_completion_tokens(source, "english")
